...
import {
  ...
  OPERATING_COST_PER_SHIP_PER_MINUTE,
...
function commandPromptLabel() {
  ...
  if (pending === "await_sensor_option") return `<${promptShipToken(selectedShip)} sensors: 1 mute, 2 instruments, 3 comms, 4 default>`;
  ...
  return `<${promptShipToken(selectedShip)} actions: ${promptShipMenuActions(selectedShip).join(", ")}>`;
}
